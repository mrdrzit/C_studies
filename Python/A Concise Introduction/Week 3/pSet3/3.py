...
Specifically, 06102016 should convert to June 17, 2016.  Actually, you
...
def problem3_3(month, day, year):
    '''Takes date of form mmddyyyy and writes it in form June 17, 2016.
    Example3_3 problem3_3(6, 17, 2016) gives June 17, 2016 '''
    
    months = ('Zero','January','February','March','April','May','June','July','August','September','October','November','December')
    print(months[month],' ',day,', ',year,sep='')
